...
@RestController
@RequestMapping("v1/direct-debit-entrys")
public class DirecDebitController {

    private final DirectDebitEntryService directDebitEntryService;

    public DirecDebitController(@Qualifier("directDebitEntryServiceJDBCClient")  DirectDebitEntryService directDebitEntryService){
